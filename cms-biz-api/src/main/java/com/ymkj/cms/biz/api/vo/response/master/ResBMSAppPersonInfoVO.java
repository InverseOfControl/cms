...
public class ResBMSAppPersonInfoVO implements Serializable{
	
	
	private static final long serialVersionUID = -8720566410642789278L;
	...
	private String issuerStateId;
	
	private String issuerCityId;
	
	private String issuerZoneId;
	...
	private String familyAvgeVenue;
	
	private String familyMonthPay;
	...
	private String homeSameRegistered;
	...
	private String corpPhoneSec;
	
	private String corpFax;
	
	private String corpDepapment;
	...
	private String corpmemFlag;
	
	private String corpmemNo;
	
	private String corpType;
	
	private String corpWorkyears;
	
	private String corpStability;
	...
	private String corpPayday;
	
	private String monthSalary;
	
	private String otherIncome;
	
	private String totalMonthSalary;
	
	private String setupDate;
	
	private String monthMaxRepay;
	...
	private String enterpriseRate;
	
	private String sharesName;
	
	private String sharesIdNo;
    ...
    private String theThirdpartyNote  ;                   
    private String theThirdpartyNoteDetails;          
    private String ifReportId ;                                                                             
    private String longOnlineId ;                                       
    private String realNameAuthId  ;                                     
    private String educationLoanId;                                          
    private String hzReportChangeInfo;
	...
	public String getFamilyAvgeVenue() {
		return familyAvgeVenue;
	}

	public void setFamilyAvgeVenue(String familyAvgeVenue) {
	...
	public String getHomeSameRegistered() {
		return homeSameRegistered;
	}

	public void setHomeSameRegistered(String homeSameRegistered) {
	...
	public String getCorpWorkyears() {
		return corpWorkyears;
	}

	public void setCorpWorkyears(String corpWorkyears) {
	...
	public String getEnterpriseRate() {
		return enterpriseRate;
	}

	public void setEnterpriseRate(String enterpriseRate) {
	...
	public String getHzReportChangeInfo() {
		return hzReportChangeInfo;
	}

	public void setHzReportChangeInfo(String hzReportChangeInfo) {
		this.hzReportChangeInfo = hzReportChangeInfo;
	}
