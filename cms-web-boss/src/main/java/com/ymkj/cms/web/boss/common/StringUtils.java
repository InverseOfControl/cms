...
public class StringUtils {
	...
	public static final String  SYMBOL_FULL_POINT =".";
	
	public static final String  SYMBOL_NULL_STRING ="";
	/**
	 * 将MAP以分隔符分隔参数字符串
	 * @param paraMap
	 * @param splitSignStr
	...
	public static String str2HtmlStr(String titleName, String content){
		...
		String startModule = headModule+"<head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><title>"+titleName+"</title></head><body>";
