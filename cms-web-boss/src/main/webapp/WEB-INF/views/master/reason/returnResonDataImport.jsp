...
<script type="text/javascript" src="${ctx}/resources/js/master/reason/returnReasonDataImport.js"></script>
<script type="text/javascript" src="${ctx}/resources/js/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript">
function showWindow(){
	$('#returnReasonDataImport').window('open').window('refresh');
	$('#returnReasonDataImportInfoForm').form('clear');
} 
...
<div id="returnReasonToolbar" style="height:92px;padding-top:8px;">
...
<div id="returnReasonDataImport" class="easyui-window" title="一键导入" data-options="top:'80px',modal:true,closed:true,iconCls:'icon-save'" style="width:300px;height:200px;padding:10px;">
      <form id="returnReasonDataImportInfoForm" name="returnReasonDataImportInfoForm"  Method="post" enctype="multipart/form-data" style="background: #FFFFFF; padding-left:10px;text-align:left;">
