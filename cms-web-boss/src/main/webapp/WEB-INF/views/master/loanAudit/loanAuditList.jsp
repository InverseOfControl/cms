...
<script type="text/javascript"
	src="${ctx}/resources/js/master/loanAudit/loanAuditList.js"></script>

<div id="queryLoanAuditDiv" class="easyui-panel W100"
	...
	<form id="manualDispatch_queryForm" class="margin_20">
		<table style="border-collapse: separate; border-spacing: 15px;">
			...
			<tr>
				<td colspan="3">
				<a class="easyui-linkbutton" iconCls="icon-search" onclick="queryBMSLoanAuditInfo();">
...
<div id="loanAuditPage" title="申请信息表查询"
	style="height: 92px; padding-top: 8px;">
	<table id="new_loanAuditDatagrid" toolbar="#toolbar"></table>
</div>
