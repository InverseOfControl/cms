...
<script type="text/javascript"
	src="${ctx}/resources/js/master/tmAppContactInfo/tmAppContactInfoList.js"></script>

<div id="queryTmAppContactInfoDiv" class="easyui-panel W100"
	...
	<form id="manualDispatch_queryForm" class="margin_20">
		<table style="border-collapse: separate; border-spacing: 15px;">
			...
			<tr>
				<td colspan="3">
				<a class="easyui-linkbutton" iconCls="icon-search" onclick="queryBMSTmAppContactInfo();">
...
<div id="tmAppContactInfoPage" title="联系人表查询"
	style="height: 92px; padding-top: 8px;">
	<table id="new_tmAppContactInfoDatagrid" toolbar="#toolbar"></table>
</div>
