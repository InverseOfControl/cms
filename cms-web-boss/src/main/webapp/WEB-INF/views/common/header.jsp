                    ...
                    if(responseText){
                        if(responseText.indexOf("login_status")>0){
                            ...
                            if(response.login_status == 300){
                              //  window.location.href = ctx+"/index";//重新登录
                              window.location.href = basePath + '/logout';
                                return true;
                            }
                        }else{
...
<div class="header">
    <div style="text-align:right; color:#ffffff; padding:8px 0px;font-size: 14px;">
        ...
        <span class="logo1" style="display:block;float: left;">
            <img style="width:100%;height:100%;" src="resources/images/logo.png"></span>
        </div>
        <span data-options="plain:true" style="font-size: 14px;">欢迎您！<%=ShiroUtils.getCurrentUser().getName()%></span> │
