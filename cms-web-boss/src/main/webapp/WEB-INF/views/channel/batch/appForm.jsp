...
<script type="text/javascript"
	src="${ctx}/resources/js/channel/batch/appForm.js"></script>
<script type="text/javascript"
...
<div id="queryLoanDiv" class="easyui-panel W100"
	...
	<form id="conditionForm" name="conditionForm">
		<table style="border-collapse: separate; border-spacing: 15px;">
			...
			<th>状态:</th>
			<td style="text-align: left"><select class="easyui-combobox"
	...
	<div style="text-align: left; padding: 5px">
		<a class="easyui-linkbutton" iconCls="icon-search" id="sercBtn"
			onclick="channel.queryTbl('conditionForm','tblAppForm','');">查询</a>
	</div>
</div>
<div title="待办任务" id="unDoneloanAudit_Page"
	data-options="region:'north'"
	style="height: 80%; border: 1px solid #95b8e7;">
	<table id="tblAppForm" class="easyui-datagrid"
		style="width: 100%; height: 80%;"
		data-options="rownumbers:true,singleSelect:true,pagination:true,onLoadSuccess:channel.gridLoadSuccess,fitColumns:true,url:'appForm/listPage',loadMsg:'数据加载中.....',method:'post'">
		<thead>
			<tr>
				<th field="" align="center" checkbox="true">全选</th>
				<th field="batchNum" width="10%" align="center">批次号</th>
				<th field="createTime" width="10%" align="center"
					data-options="formatter:channel.dataTimeFmt">生成时间</th>
				<th field="status" width="10%" align="center">状态</th>
				<th field="operate" width="67%" align="center"
					data-options="formatter:operateFmt">操作</th>
			</tr>
		</thead>
	</table>
</div>
