package com.ymkj.cms.biz.service.sign.lxxd.ifc;
 ...
 */
@Service
public class LongXinXDInterfaceService{

	private Logger logger = LoggerFactory.getLogger(LongXinXDInterfaceService.class);
