package com.ymkj.cms.biz.service.sign.hmxd.ifc;
 ...
 */
@Service
public class HaiMenXDInterfaceService{

	private Logger logger = LoggerFactory.getLogger(HaiMenXDInterfaceService.class);
