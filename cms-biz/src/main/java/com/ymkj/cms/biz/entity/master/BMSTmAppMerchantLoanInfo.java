...
/**
 * 实体类 对应 表 BMS_TM_APP_MERCHANT_LOAN_INFO
 */
public class BMSTmAppMerchantLoanInfo extends BaseEntity{
	
	/**
	 * 序列号
	 */
	private static final long serialVersionUID = -5726232946451071598L;
