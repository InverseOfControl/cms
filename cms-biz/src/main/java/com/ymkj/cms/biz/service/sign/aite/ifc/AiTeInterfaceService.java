package com.ymkj.cms.biz.service.sign.aite.ifc;
 ...
 */
@Service
public class AiTeInterfaceService{
	...
	private Logger logger = LoggerFactory.getLogger(AiTeInterfaceService.class);
