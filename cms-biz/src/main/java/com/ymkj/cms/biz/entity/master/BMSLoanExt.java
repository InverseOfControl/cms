...
public class BMSLoanExt extends BaseEntity {

    /**
     *
     */
    private static final long serialVersionUID = 6992903183660724665L;
    ...
    private String byState;//包银状态值 0黑名单拒绝 1黑名单通过 2银行卡鉴权拒绝 3鉴权通过 4风控信息推送失败 5风控信息推送成功 6影像资料推送失败 7影像资料推送成功
    private String byRefusalResult;//包银黑名单拒绝原因
    private String windControlDate;//授信信息推送时间
    private String windControlResult;//风控结果
    private String auditingState;//人工审核状态 0审核中（风控和合同签订） 1图像资料待上传（风控通过）  2拒绝（风控和合同签订） 3补件（合同签订）  4通过（合同签订）';
