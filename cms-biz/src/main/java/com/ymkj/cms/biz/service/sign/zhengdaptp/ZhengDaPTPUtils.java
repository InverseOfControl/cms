...
@Component
public class ZhengDaPTPUtils {

	private final static Logger logger = LoggerFactory.getLogger(ZhengDaPTPUtils.class);
	 ...
	 */
	public static JSONArray zhengDaPTPPicUpload(JSONArray listMap){
