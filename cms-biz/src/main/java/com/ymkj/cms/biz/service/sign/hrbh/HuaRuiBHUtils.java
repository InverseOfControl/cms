...
@Component
public class HuaRuiBHUtils {

	private final static Logger logger = LoggerFactory.getLogger(HuaRuiBHUtils.class);
	 ...
	 */
	public static JSONArray huaRuiBHPicUpload(JSONArray listMap){
