...
public class FileFormEntity  extends BMSProductBaseEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2788572435796981726L;
	...
	private String loanBarnchId; //放款营业部ID
	...
	public String getLoanBarnchId() {
		return loanBarnchId;
	}
	public void setLoanBarnchId(String loanBarnchId) {
		this.loanBarnchId = loanBarnchId;
	}
