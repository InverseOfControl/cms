...
@Component
public class WaiMaoTUtils {

	private final static Logger logger = LoggerFactory.getLogger(WaiMaoTUtils.class);
	 ...
	 */
	public static JSONArray waiMaoTPicUpload(JSONArray listMap){
		JSONArray jsonArray = new JSONArray();
		//身份证、贷款合同、委托扣款授权书_证大、申请表
