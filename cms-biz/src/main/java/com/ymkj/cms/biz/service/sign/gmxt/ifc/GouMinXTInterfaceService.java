package com.ymkj.cms.biz.service.sign.gmxt.ifc;
 ...
 */
@Service
public class GouMinXTInterfaceService{

	private Logger logger = LoggerFactory.getLogger(GouMinXTInterfaceService.class);
