...
@Component
public class WaiMaoXTUtils {

	private final static Logger logger = LoggerFactory.getLogger(WaiMaoXTUtils.class);
	 ...
	 */
	public static JSONArray waiMaoXTPicUpload(JSONArray listMap){
