...
@Component
public class HaiMenXDUtils {

	private final static Logger logger = LoggerFactory.getLogger(HaiMenXDUtils.class);
	 ...
	 */
	public static JSONArray haiMenXDPicUpload(JSONArray listMap){
