...
/**
 * 实体类 对应 表 BMS_TM_APP_MASTER_LOAN_INFO
 */
public class BMSTmAppMasterLoanInfo extends BaseEntity{
	
	/**
	 * 序列号
	 */
	private static final long serialVersionUID = 7544035679181146231L;
	private Long id;
