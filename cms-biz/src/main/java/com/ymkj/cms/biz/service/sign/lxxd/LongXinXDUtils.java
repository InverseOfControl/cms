...
@Component
public class LongXinXDUtils {

	private final static Logger logger = LoggerFactory.getLogger(LongXinXDUtils.class);
	 ...
	 */
	public static JSONArray longXinXDPicUpload(JSONArray listMap){
