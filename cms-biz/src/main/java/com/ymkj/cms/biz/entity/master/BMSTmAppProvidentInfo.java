...
/**
 * 实体类 对应 表 BMS_TM_APP_PROVIDENT_INFO
 */
public class BMSTmAppProvidentInfo extends BaseEntity{
	
	/**
	 * 序列号
	 */
	private static final long serialVersionUID = 3187563392624711482L;
