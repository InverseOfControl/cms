...
@Component
public class GouMinXTUtils {

	private final static Logger logger = LoggerFactory.getLogger(GouMinXTUtils.class);
	 ...
	 */
	public static JSONArray gouMinXTPicUpload(JSONArray listMap){
