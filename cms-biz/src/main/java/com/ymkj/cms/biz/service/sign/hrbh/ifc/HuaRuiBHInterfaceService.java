package com.ymkj.cms.biz.service.sign.hrbh.ifc;
 ...
 */
@Service
public class HuaRuiBHInterfaceService{

	private Logger logger = LoggerFactory.getLogger(HuaRuiBHInterfaceService.class);
