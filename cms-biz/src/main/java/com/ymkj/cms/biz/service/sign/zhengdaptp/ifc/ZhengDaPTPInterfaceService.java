package com.ymkj.cms.biz.service.sign.zhengdaptp.ifc;
 ...
 */
@Service
public class ZhengDaPTPInterfaceService{

	private Logger logger = LoggerFactory.getLogger(ZhengDaPTPInterfaceService.class);
