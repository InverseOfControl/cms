package com.ymkj.cms.biz.service.sign.bohai.two.ifc;
 ...
 */
@Service
public class BoHaiTwoInterfaceService{

	private Logger logger = LoggerFactory.getLogger(BoHaiTwoInterfaceService.class);
